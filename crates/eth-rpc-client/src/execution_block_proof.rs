...
/// The `block_hash` is the 12th field in execution_payload, which is the 9th field in
/// `BeaconBlockBody` The first 4 elements in proof correspondent to the proof of inclusion of
/// `block_hash` in Merkle tree built for `ExecutionPayload`.
